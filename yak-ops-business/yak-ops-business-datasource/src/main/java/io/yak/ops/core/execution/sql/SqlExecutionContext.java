...
public record SqlExecutionContext(SqlExecutionCaller caller, String callerReference, String operator) {
    ...
    public static SqlExecutionContext of(SqlExecutionCaller caller, String callerReference, String operator) {
