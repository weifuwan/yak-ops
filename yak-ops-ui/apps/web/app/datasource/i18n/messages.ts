export default {
  ...
  "pages.datasource.form.propertySelectPlaceholder": "选择参数，支持多选",
  "pages.datasource.form.propertySelectEmpty": "没有匹配的参数",
  "pages.datasource.form.propertyKeysLoading": "正在加载参数...",
