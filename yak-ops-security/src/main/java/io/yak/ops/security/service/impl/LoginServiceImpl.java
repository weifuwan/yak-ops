...
public class LoginServiceImpl implements LoginService {
    ...
    public UserBriefVO verifyLogin(AccountLoginDTO loginDTO, HttpServletRequest request, HttpServletResponse response) {
        ...
        return loginExtend.verifyLogin(loginDTO, request, response);
    }
    ...
    public Result<Boolean> logout(HttpServletRequest request, HttpServletResponse response) {
        ...
        return loginExtend.logout(request, response);
    }
    ...
    public boolean interceptorCheck(
        ...
        return loginExtend.interceptorCheck(request, response, requestMappingValue, safeWhiteMappingValues);
    }
}
