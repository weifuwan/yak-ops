...
public class DataSourceManager {
    ...
    public boolean create(DataSourceConfigurationCommand command) {
        ...
        ConnectionProfile connectionProfile = connectionResolver.normalize(command.dbType(), command.connectionJson());
        DataSourceDefinition definition = DataSourceDefinition.create(
                command.name(), command.dbType(), connectionProfile, command.environment(), command.remark());
    ...
    public boolean update(Long id, DataSourceConfigurationCommand command) {
        ...
        ConnectionProfile connectionProfile = connectionResolver.mergeStoredSecrets(existing, command.connectionJson());
    ...
    private void assertTypeUnchanged(DataSourceDefinition existing, DataSourceConfigurationCommand command) {
        try {
