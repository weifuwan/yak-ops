...
public final class ObservableSqlExecutionRuntime implements SqlExecutionRuntime {
    ...
    public SqlExecutionResult execute(SqlExecutionRequest request) {
        ...
        try {
            ...
            SqlExecutionStatus executionStatus = timedOut ? SqlExecutionStatus.TIMED_OUT : SqlExecutionStatus.FAILED;
            SqlStatementStatus statementStatus = timedOut ? SqlStatementStatus.TIMED_OUT : SqlStatementStatus.FAILED;
    ...
    public SqlExecutionSnapshot start(SqlExecutionPlan plan) {
        ...
        try {
            ...
            log.warn(
                    "Unable to schedule SQL execution observability: executionId={}", started.executionId(), exception);
        }
        return started;
    }
