...
public class MybatisPlusConfiguration {
    ...
    public PlatformTransactionManager yakOpsTransactionManager(@Qualifier("dataSource") DataSource dataSource) {
    ...
    public SqlSessionFactory yakBusinessSqlSessionFactory(@Qualifier("dataSource") DataSource dataSource)
            throws Exception {
    ...
    public SqlSessionFactory yakSecuritySqlSessionFactory(
            @Qualifier("dataSource") DataSource dataSource, YakSecurityProperties properties) throws Exception {
    ...
    private static SqlSessionFactory requireFactory(SqlSessionFactory sqlSessionFactory, String beanName) {
